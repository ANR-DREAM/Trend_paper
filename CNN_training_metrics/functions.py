...
def chloro_prediction(ds_input,model,log,d1_pred,d2_pred,Xm,Xstd,Cm,Cstd,var_input,anomaly):
    """
...
def test_metrics(ds_out,log,d1_test, d2_test,anomaly):
    """
...
def plot_trend(ds_out, output, input_name, log,d1_pred,d2_pred,d1_train,d2_train,anomaly,t):
    """
    ...
    if anomaly:
        y_pred.chloro_pred.plot(ax = ax[1],cmap = cmocean.cm.balance,vmin = -1,vmax = 1)
        y_test.chloro.plot(ax = ax[0],cmap = cmocean.cm.balance,vmin = -1,vmax = 1)
